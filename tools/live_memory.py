...
Emits one JSON object per line on stdout, which the optional native live-mode bridge can consume:
...
# the native live-height validator) and ignores the rest, so a chain that is
